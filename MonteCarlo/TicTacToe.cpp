...
void TicTacToe::place(int row, int col)
{
...
std::vector<int> TicTacToe::getAllValidMoves()
{
...
bool TicTacToe::operator==(const TicTacToe& rhs) const
{
	for (int i = 0; i < 3; i++) {
		for (int j = 0; j < 3; j++) {
